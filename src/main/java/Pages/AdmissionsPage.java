...
public class AdmissionsPage extends Base {
    ...
    private static By applyNow=By.xpath("//*[@id=\"menu-item-2264\"]/a/span"); // //*[@id="menu-item-654"]/a/span
    ...
    public static void mouseOver(){
        ...
        driver.findElement(admissions);
        actions.moveToElement(dr.findElement(admissions));
        try {
            Thread.sleep(6000);
